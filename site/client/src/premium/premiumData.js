...
export const CRM = {
  members: [
    ...
    { id: 'u3', name: 'Mathieu Gagnon', first: 'Mathieu', initials: 'MG', color: '#4E9088', role: 'Agent' },
    ...
    { id: 'u6', name: 'Noémie Lavoie', first: 'Noémie', initials: 'NL', color: '#96578A', role: 'Admin' },
  ...
  boards: [
    ...
    { id: 'b2', name: 'Westmount Luxury Listings', icon: 'diamond', color: '#B08A3C' },
    ...
    { id: 'b6', name: 'South Shore Rentals', icon: 'key', color: '#4E9088' },
