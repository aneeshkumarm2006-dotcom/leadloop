  ...
  const links = [
    ...
    ...(isAdmin
      ? [
          ...
          { to: '/duplicates', label: t('duplicates.nav', 'Duplicates'), icon: CopyCheck },
          { to: '/compliance', label: t('compliance.nav', 'Compliance'), icon: ShieldCheck },
          { to: '/response-clock', label: t('sla.nav', 'Response clock'), icon: Timer },
          { to: '/import', label: t('import.nav', 'Import'), icon: FileSpreadsheet },
