...
const PROVIDERS = [
  ...
  { id: 'ics', name: 'Calendar / .ics', mono: '31', color: '#4E7A70', cat: 'cal', channel: 'calendar', desc: { en: 'Add booked visits to any calendar with .ics feeds.', fr: 'Ajoutez les visites à tout calendrier via des flux .ics.' } },
